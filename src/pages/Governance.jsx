...
/* مجلس الإدارة — وفق التقرير السنوي 2025 (بلا صور بطلب الجمعية؛
   البطاقة المصورة PhotoMemberCard تُفعّل تلقائياً لأي عضو يُضاف له photo) */
const BOARD = [
  { name: 'د. محمد بن محسن الأسمري', role: 'رئيس مجلس الإدارة' },
  { name: 'أ. عبدالله بن سعود التمامي', role: 'نائب رئيس مجلس الإدارة' },
  { name: 'أ. خالد بن حمود القحطاني', role: 'المشرف المالي' },
  { name: 'أ. حسن بن خزمان الأسمري', role: 'عضو' },
  { name: 'أ. بندر بن عايض الرقاص', role: 'عضو' },
]

const ASSEMBLY = [
  { name: 'أ. عمر بن محمد الدوسري' },
  { name: 'أ. عبدالعزيز بن محمد الزعيبر' },
  { name: 'د. عبدالله بن عايض العتيبي' },
  { name: 'أ. شعلان بن عثمان الشعلان' },
  { name: 'أ. عبدالعزيز بن خالد الدريهم' },
]
