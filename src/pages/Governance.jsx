...
/* مجلس الإدارة — وفق التقرير السنوي 2025 */
/* ⚠️ الصور مؤقتاً صورة واحدة (المدير التنفيذي) حتى تصل صور الأعضاء الحقيقية */
const TEMP_PHOTO = '/images/members/abukhalid.png'
const BOARD = [
  { name: 'د. محمد بن محسن الأسمري', role: 'رئيس مجلس الإدارة', photo: TEMP_PHOTO },
  { name: 'أ. عبدالله بن سعود التمامي', role: 'نائب رئيس مجلس الإدارة', photo: TEMP_PHOTO },
  { name: 'أ. خالد بن حمود القحطاني', role: 'المشرف المالي', photo: TEMP_PHOTO },
  { name: 'أ. حسن بن خزمان الأسمري', role: 'عضو', photo: TEMP_PHOTO },
  { name: 'أ. بندر بن عايض الرقاص', role: 'عضو', photo: TEMP_PHOTO },
]

const ASSEMBLY = [
  { name: 'أ. عمر بن محمد الدورسي', photo: TEMP_PHOTO },
  { name: 'أ. عبدالعزيز بن محمد الزعيرب', photo: TEMP_PHOTO },
  { name: 'أ. عبدالله بن عايض العتيبي', photo: TEMP_PHOTO },
  { name: 'أ. شعلان بن عثمان الشعلان', photo: TEMP_PHOTO },
  { name: 'أ. عبدالعزيز بن خالد الدريهم', photo: TEMP_PHOTO },
]

const EXECUTIVE = { name: 'أ. عبدالملك بن خالد الدريهم', role: 'المدير التنفيذي', photo: '/images/members/abukhalid.png' }
...
/* ⚠️ مسودة مصاغة من محتوى الموقع المعتمد فقط — تُعرض على المدير
   التنفيذي لاعتمادها أو استبدالها بكلمته الفعلية قبل الإطلاق. */
const EXEC_WORD = [
  'الحمد لله رب العالمين، والصلاة والسلام على نبينا محمد وعلى آله وصحبه أجمعين، أما بعد:',
  'في رواسم نؤمن أن بناء الطفل هو بناءٌ للمستقبل؛ فالقيمة التي تترسخ في قلب طفلٍ اليوم، تصبح غدًا سلوكًا في بيته، وأثرًا في مدرسته، وبصمةً في مجتمعه. من هذا الإيمان انطلقنا، وعليه نبني برامجنا وتجاربنا التربوية.',
  'نحن لا نقدم أنشطة عابرة؛ بل نصمم تجارب تربوية متكاملة تجمع بين ترسيخ القيم وتنمية المهارات والتعلم بالممارسة، وترافق المستفيد في رحلة بنائه مرحلةً بعد مرحلة، حتى ينتقل من التلقي إلى المبادرة، ومن المشاركة إلى تحمل المسؤولية وصناعة الأثر في نفسه ومحيطه.',
  'وما كان لهذا العمل أن يمتد لولا فضل الله، ثم تكاتف فريق العمل والمتطوعين والمتطوعات الذين يصنعون التجربة بأيديهم، وشركائنا الذين وسّعوا نطاق الوصول والأثر، وأولياء الأمور الذين منحونا ثقتهم في أغلى ما يملكون.',
  'إننا في رواسم نمضي بعزيمة لا تفتر، ورؤية تتسع كل عام؛ لنكون بيئة تربوية يعتز فيها الجيل بقيمه، ويصنع أثره. وندعوكم جميعًا — أفرادًا وجهات — أن تكونوا جزءًا من هذه الرحلة.',
]
...
/* ملفات القسم — يُضاف file: '/files/....pdf' لكل بطاقة فور رفع النسخة المعتمدة */
const REPORT_TYPES = ['التقارير السنوية', 'القوائم المالية']
const REPORT_FILES = [
  {
    title: 'التقرير السنوي 2025',
    type: 'التقارير السنوية', year: '2025',
    desc: 'يوثق منجزات رواسم ومؤشرات أدائها وبرامجها خلال العام.',
    file: null,
  },
  {
    title: 'القوائم المالية 2025',
    type: 'القوائم المالية', year: '2025',
    desc: 'القوائم المالية المدققة وفق الوثائق المعتمدة والمتطلبات النظامية.',
    file: null,
  },
]
...
/* لا تُفترض وثيقة لم تُستلم — تُضاف البطاقات هنا فور اعتماد كل وثيقة:
   { title, type: 'اللوائح'|'السياسات'|'الإفصاحات', year?, file: '/files/....pdf' } */
