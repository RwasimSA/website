...
/* ─────────────────────────────────────────────────────────────
   ...
   | الأهداف الاستراتيجية | الأهداف التشغيلية | نهج رواسم | ختام الصفحة.
...
/* الأهداف التشغيلية — نص معتمد حرفياً: lead العبارة البارزة وrest التكملة.
   تُعرض مدمجة مرقمة (وعلى الجوال أول خمسة مع زر لعرض البقية حتى لا تطول الصفحة) */
const OPERATIONAL_GOALS = [
  { lead: 'تصميم وتنفيذ برامج تربوية متخصصة', rest: 'تسهم في غرس الإحسان وتعزيز القيم والسلوك الإيجابي لدى الأطفال والناشئة.' },
  { lead: 'تطوير منظومة معرفية وتربوية متكاملة', rest: 'تلبي احتياجات المستفيدين وتتناسب مع خصائص مراحلهم العمرية.' },
  { lead: 'تطوير المناهج والمحتوى التربوي والتعليمي', rest: 'بما يعزز القيم والمعارف والمهارات لدى الأطفال والناشئة.' },
  { lead: 'رفع مستوى التحصيل الدراسي للمستفيدين', rest: 'من خلال برامج تعليمية داعمة وأساليب تعلم فاعلة وموجهة.' },
  { lead: 'تنمية المهارات الحياتية والشخصية لدى المستفيدين', rest: 'بما يعزز الثقة بالنفس والاستقلالية وتحمل المسؤولية.' },
  { lead: 'تنمية القدرات القيادية وروح المبادرة والتأثير الإيجابي', rest: 'لدى الأطفال والناشئة.' },
  { lead: 'ابتكار وتطوير برامج وحلول تربوية نوعية', rest: 'تستجيب للاحتياجات المتجددة والمتنوعة للمستفيدين.' },
  { lead: 'تطوير أساليب تقديم البرامج والتجارب التربوية', rest: 'بما يعزز التفاعل والاستفادة ويوسع نطاق الوصول إلى المستفيدين.' },
  { lead: 'رفع جودة البرامج والممارسات التربوية وقياس أثرها', rest: 'بما يسهم في التحسين المستمر وتحقيق أثر تربوي مستدام.' },
]
  ...
  return (
    <div dir="rtl" className="relative w-full overflow-hidden pb-28 pt-36">
      ...
      <div className="relative mx-auto w-full max-w-6xl px-6 md:px-10">
        ...
        <SectionTitle>الأهداف الاستراتيجية</SectionTitle>
